...
const { respondToInteraction, respondWithError, MESSAGES, WEATHER_REGIONS } = require('./utils');
const { setUserSetting, getUserSetting } = require('../../util/database'); // Assuming database has settings

module.exports = {
  data: new SlashCommandBuilder()
    .setName('天氣')
    .setDescription('查詢天氣資訊')
